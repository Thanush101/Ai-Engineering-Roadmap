...
df = pd.read_csv('books_dataset.csv',usecols=[ 2,4,5,7])
...
user_profile = "I like reading horror books which are related to ghosts and spirits. I also like reading books which are related to science fiction and fantasy. I don't like reading books which are related to romance and mystery."
